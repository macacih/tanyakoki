...
import 'package:tanyakokii/screens/step_screen.dart';
...
class BahanBahan extends StatefulWidget {
  final snap;
  const BahanBahan({
    Key? key,
    required this.snap,
  ...
  @override
  State<BahanBahan> createState() => _BahanCardState();
}

class _BahanCardState extends State<BahanBahan> {
  int commentLen = 0;
